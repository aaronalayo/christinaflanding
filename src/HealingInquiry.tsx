...
const s: Styles = {
  ...
  button:           { padding: '12px 18px', background: '#ffffff', color: '#1f2c22', border: '0', borderRadius: '0', fontWeight: '700', fontSize: '14px', marginTop: '6px', cursor: 'pointer', fontFamily: '"Avenir Next", "Avenir", "Helvetica Neue", "Segoe UI", sans-serif', letterSpacing: '0.04em', textTransform: 'uppercase', transition: 'transform 0.2s ease, box-shadow 0.2s ease, background-color 0.2s ease, border-color 0.2s ease' },
