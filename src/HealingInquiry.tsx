...
const s: Styles = {
  container:        { maxWidth: '620px', margin: '28px auto', padding: '26px', fontFamily: 'Georgia, serif', border: '1px solid #d9d0c8', borderRadius: '0', backgroundColor: '#f5f0ea', boxShadow: 'none' },
  heading:          { color: '#1f2c22', margin: '0 0 10px 0', fontWeight: '700', fontSize: '24px', letterSpacing: '-0.02em' },
  subheading:       { color: '#4f5f4d', margin: 0, fontSize: '14px', fontStyle: 'italic' },
  form:             { display: 'flex', flexDirection: 'column', gap: '12px' },
  row:              { display: 'flex', gap: '15px', flexWrap: 'wrap' },
  formGroup:        { display: 'flex', flexDirection: 'column', gap: '6px', flex: '1 1 200px' },
  label:            { fontSize: '13px', fontWeight: '700', color: '#1f2c22', fontFamily: 'sans-serif' },
  input:            { padding: '12px', borderRadius: '0', border: '1px solid #b8a896', fontSize: '15px', outline: 'none', backgroundColor: '#f1eae3', fontFamily: 'sans-serif', color: '#1f2c22' },
  inputPlaceholder: { color: '#6a5d52' },
  button:           { padding: '12px 18px', background: '#d8c7b3', color: '#1f2c22', border: '1px solid #93806d', borderRadius: '0', fontWeight: '700', fontSize: '14px', marginTop: '6px', cursor: 'pointer', fontFamily: 'sans-serif', letterSpacing: '0.04em', textTransform: 'uppercase', transition: 'transform 0.2s ease, box-shadow 0.2s ease, background-color 0.2s ease, border-color 0.2s ease' },
  successContainer: { maxWidth: '520px', margin: '60px auto', padding: '36px 28px', textAlign: 'center', fontFamily: 'Georgia, serif', background: '#f5f0ea', borderRadius: '0', border: '1px solid #d9d0c8', boxShadow: 'none' },
  confirmedCard:    { backgroundColor: '#f3efe9', padding: '16px', borderRadius: '0', border: '1px solid #d9d0c8', margin: '16px 0 20px', fontFamily: 'sans-serif' },
  gcalBtn:          { display: 'inline-block', padding: '12px 20px', backgroundColor: '#e7dfd6', color: '#1f2c22', textDecoration: 'none', borderRadius: '0', fontWeight: '700', fontSize: '14px', fontFamily: 'sans-serif', transition: 'transform 0.2s ease, box-shadow 0.2s ease, background-color 0.2s ease' },
  efterAftaleBox:   { display: 'flex', alignItems: 'flex-start', gap: '12px', padding: '14px', borderRadius: '0', borderLeft: '3px solid #6d846f', backgroundColor: '#efebe7', fontFamily: 'sans-serif' },
  summary:          { fontFamily: 'sans-serif', fontSize: '14px', color: '#1f2c22', backgroundColor: '#f1eee8', padding: '10px 16px', borderRadius: '0', border: '1px solid #d9d0c8', marginTop: '4px' },
  privacyNote:      { margin: 0, padding: '12px 14px', backgroundColor: '#f3efe9', borderLeft: '3px solid #c7bdae', color: '#4f5f4d', fontFamily: 'sans-serif', fontSize: '13px', lineHeight: '1.5' },
  checkboxLabel:    { display: 'flex', alignItems: 'flex-start', gap: '9px', color: '#2d4b2d', fontFamily: 'sans-serif', fontSize: '13px', lineHeight: '1.5' },
};

// Button variants
const sc: Styles = {
  dayBtn:        { flex: '1 1 90px', padding: '12px 8px', borderRadius: '0', border: '1px solid #b9a994', backgroundColor: '#f1eae3', color: '#1f2c22', fontFamily: 'Georgia, serif', cursor: 'pointer', transition: 'transform 0.2s ease, box-shadow 0.2s ease, background-color 0.2s ease, border-color 0.2s ease', textAlign: 'center' },
  dayBtnActive:  { flex: '1 1 90px', padding: '12px 8px', borderRadius: '0', border: '1px solid #93806d', backgroundColor: '#d8c7b3', color: '#1f2c22', fontFamily: 'Georgia, serif', cursor: 'pointer', transition: 'transform 0.2s ease, box-shadow 0.2s ease, background-color 0.2s ease, border-color 0.2s ease', textAlign: 'center', boxShadow: 'none' },
  dateBtn:       { padding: '9px 16px', borderRadius: '0', border: '1px solid #b9a994', backgroundColor: '#f1eae3', color: '#1f2c22', fontFamily: 'sans-serif', fontSize: '13px', fontWeight: '600', cursor: 'pointer', transition: 'transform 0.2s ease, box-shadow 0.2s ease, background-color 0.2s ease, border-color 0.2s ease' },
  dateBtnActive: { padding: '9px 16px', borderRadius: '0', border: '1px solid #93806d', backgroundColor: '#d8c7b3', color: '#1f2c22', fontFamily: 'sans-serif', fontSize: '13px', fontWeight: '700', cursor: 'pointer', transition: 'transform 0.2s ease, box-shadow 0.2s ease, background-color 0.2s ease, border-color 0.2s ease', boxShadow: 'none' },
  dateBtnBooked: { padding: '9px 14px', borderRadius: '0', border: '1px solid #d7d7d7', backgroundColor: '#f0f0f0', color: '#8b8b8b', fontFamily: 'sans-serif', fontSize: '12px', cursor: 'not-allowed', opacity: 0.75 },
  moreBtn:       { padding: '9px 15px', borderRadius: '0', border: '1px dashed #93806d', backgroundColor: '#eadfce', color: '#2d4b2d', fontFamily: 'sans-serif', fontSize: '13px', fontWeight: '700', cursor: 'pointer', transition: 'transform 0.2s ease, box-shadow 0.2s ease, background-color 0.2s ease, border-color 0.2s ease' },
  ...
  calendarInput: { padding: '8px 12px', borderRadius: '0', border: '1px solid #b8a896', backgroundColor: '#f1eae3', color: '#1f2c22', fontFamily: 'sans-serif', fontSize: '13px', outline: 'none', cursor: 'pointer' },
  timeBtn:       { flex: '1 1 0', padding: '13px 8px', borderRadius: '0', border: '1px solid #b9a994', backgroundColor: '#f1eae3', color: '#1f2c22', fontFamily: 'sans-serif', fontSize: '15px', fontWeight: '600', cursor: 'pointer', transition: 'transform 0.2s ease, box-shadow 0.2s ease, background-color 0.2s ease, border-color 0.2s ease', textAlign: 'center' },
  timeBtnActive: { flex: '1 1 0', padding: '13px 8px', borderRadius: '0', border: '1px solid #93806d', backgroundColor: '#d8c7b3', color: '#1f2c22', fontFamily: 'sans-serif', fontSize: '15px', fontWeight: '700', cursor: 'pointer', transition: 'transform 0.2s ease, box-shadow 0.2s ease, background-color 0.2s ease, border-color 0.2s ease', textAlign: 'center', boxShadow: 'none' },
  timeBtnBooked: { flex: '1 1 0', padding: '10px 8px', borderRadius: '0', border: '1px solid #d7d7d7', backgroundColor: '#f0f0f0', color: '#8b8b8b', fontFamily: 'sans-serif', fontSize: '14px', cursor: 'not-allowed', textAlign: 'center', opacity: 0.7 },
};
